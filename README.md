...
### Option 2 : Compilation locale (Avec g++ / VS Code)
Si vous avez un environnement C++ configuré (ex: MSYS2/MinGW ou WSL), vous pouvez compiler les fichiers directement :
```bash
